...
<section class="page-section" id="create-testimonial">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card testimonial-form-card">
                    <div class="card-header">Berikan Testimoni</div>
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('testimonial.store') }}">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('content') is-invalid @enderror" id="content" name="content" rows="4" placeholder="Bagikan pengalaman Anda..."></textarea>
                                @error('content')
