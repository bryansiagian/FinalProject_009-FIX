            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Tambah Informasi Kontak</h1>
                        ...
                        <div class="col-xl-12 col-lg-12">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-primary">Form Tambah Informasi Kontak</h6>
                                </div>
                                <!-- Card Body -->
                                <div class="card-body">
                                    @if(session('Success'))
                                    ...
                                    <form action="{{ route('admin.kontak.store') }}" method="POST">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control @error('peta') is-invalid @enderror" id="peta" name="peta" rows="5">{{ old('peta') }}</textarea>
                                            @error('peta')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
