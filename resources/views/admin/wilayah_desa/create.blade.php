                        ...
                        <div class="col-xl-12 col-lg-12">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-primary">Form Tambah Wilayah/Desa</h6>
                                </div>
                                <!-- Card Body -->
                                <div class="card-body">
                                    @if(session('Success'))
                                    ...
                                    <form action="{{ route('admin.wilayah-desa.store') }}" method="POST">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="number" step="0.01" class="form-control @error('ongkos_kirim') is-invalid @enderror" name="ongkos_kirim" id="ongkos_kirim" value="{{ old('ongkos_kirim', 0.00) }}" required>
                                            @error('ongkos_kirim')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-control @error('tersedia_delivery') is-invalid @enderror" name="tersedia_delivery" id="tersedia_delivery" required>
                                                <option value="1" {{ old('tersedia_delivery') == '1' ? 'selected' : '' }}>Ya</option>
                                                <option value="0" {{ old('tersedia_delivery') == '0' ? 'selected' : '' }}>Tidak</option>
                                            </select>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control @error('kode_pos') is-invalid @enderror" name="kode_pos" id="kode_pos" value="{{ old('kode_pos') }}">
                                            @error('kode_pos')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
