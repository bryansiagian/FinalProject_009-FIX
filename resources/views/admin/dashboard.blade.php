            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <!-- Jumlah Kode Pos -->
                        <div class="col-xl-3 col-md-6 mb-4">
                            <a href="{{ route('admin.wilayah-desa.index') }}" class="card-link">
                                <div class="card border-left-secondary shadow h-100 py-2">
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                <div class="text-xs font-weight-bold text-secondary text-uppercase mb-1">Wilayah Desa</div>
                                                <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $jumlahWilayahDesa }}</div>
                                            </div>
                                            <div class="col-auto">
                        ...
                        @php
                            $jumlahTestimoniPending = \App\Models\Testimonial::where('status', 'pending')->count();
                        @endphp
                        <div class="col-xl-3 col-md-6 mb-4">
                            <a href="{{ route('admin.testimonials.index') }}" class="card-link">
                                <div class="card border-left-warning shadow h-100 py-2">
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">Testimoni Menunggu Persetujuan</div>
                                                <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $jumlahTestimoniPending }}</div>
                                            </div>
                                            <div class="col-auto">
                                                <i class="fas fa-comment-dots fa-2x text-gray-300"></i>
                                            </div>
